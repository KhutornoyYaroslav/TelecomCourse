...
void* threadHandler(void* args)
{
     struct sockaddr_in server_addr;
         int server_addr_size=sizeof(server_addr);
            ...
            int bsize=recvfrom(client_sockfd, (char*)&msg, sizeof(msg), 0, (struct sockaddr *)&server_addr, &server_addr_size);
    ...
    for(;;)
    {
       struct  sockaddr_in server_addr2;
         int server_addr_size2=sizeof(server_addr2);
            ...
            int bsize=recvfrom(client_sockfd2, (char*)&msg, sizeof(msg), 0, (struct sockaddr *)&server_addr2, &server_addr_size2);
       ...
       if (nummenu == 2)
        {
           ...
           sendto(client_sockfd2, (char*)&msg2, sizeof(msg2), 0, (struct sockaddr *)&server, sizeof(server));
...
sendto(client_sockfd, (char*)&msg2, sizeof(msg2), 0, (struct sockaddr *)&server, sizeof(server));
msg2.messageType = 0;
